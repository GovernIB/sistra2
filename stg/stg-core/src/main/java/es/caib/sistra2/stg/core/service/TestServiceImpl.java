package es.caib.sistra2.stg.core.service;
...
import es.caib.sistra2.stg.core.api.exception.TestException;
import es.caib.sistra2.stg.core.api.model.TestData;
import es.caib.sistra2.stg.core.api.service.TestService;
import es.caib.sistra2.stg.core.interceptor.NegocioInterceptor;
import es.caib.sistra2.stg.core.service.component.TestComponent;
