package es.caib.sistra2.stg.core.interceptor;
...
import es.caib.sistra2.stg.core.api.exception.DatabaseException;
import es.caib.sistra2.stg.core.api.exception.ErrorNoControladoException;
import es.caib.sistra2.stg.core.api.exception.ServiceException;
import es.caib.sistra2.stg.core.api.exception.ServiceRollbackException;
import es.caib.sistra2.stg.core.api.model.comun.ConstantesNumero;
...
public final class NegocioInterceptorAspect {
   ...
   *          JointPoint
   */
  @Before("@annotation(es.caib.sistra2.stg.core.interceptor.NegocioInterceptor)")
   ...
   *          Objeto retornado
   */
  @AfterReturning(pointcut = "@annotation(es.caib.sistra2.stg.core.interceptor.NegocioInterceptor)", returning = "retVal")
   ...
   *          Exception
   */
  @AfterThrowing(pointcut = "@annotation(es.caib.sistra2.stg.core.interceptor.NegocioInterceptor)", throwing = "ex")
