...
public class TestClient {
	...
	public static void main(final String[] args) {
		...
		final String responseStr = ClientBuilder.newClient()
				.target("http://localhost:8080/sistra2back/stg-rest/rest/ejemploRest").path("recuperaDato5")
		...
		final String response6 = ClientBuilder.newClient()
				.target("http://localhost:8080/sistra2back/stg-rest/rest/ejemploRest").path("recuperaDato6")
		...
		final String resp7 = ClientBuilder.newClient()
				.target("http://localhost:8080/sistra2back/stg-rest/rest/ejemploRest").path("recuperaDato7")
				.request(MediaType.APPLICATION_JSON_TYPE).accept(MediaType.APPLICATION_JSON)
				.header(authorizationHeaderName, authorizationHeaderValue)
				.post(Entity.entity(form, MediaType.APPLICATION_FORM_URLENCODED_TYPE), String.class);
