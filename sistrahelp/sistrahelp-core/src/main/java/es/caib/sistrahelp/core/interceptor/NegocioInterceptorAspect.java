package es.caib.sistrahelp.core.interceptor;
...
import es.caib.sistrahelp.core.api.exception.DatabaseException;
import es.caib.sistrahelp.core.api.exception.ErrorNoControladoException;
import es.caib.sistrahelp.core.api.exception.ServiceException;
import es.caib.sistrahelp.core.api.exception.ServiceRollbackException;
...
public final class NegocioInterceptorAspect {
	 ...
	 *            JointPoint
	 */
	@Before("@annotation(es.caib.sistrahelp.core.interceptor.NegocioInterceptor)")
	 ...
	 *            Objeto retornado
	 */
	@AfterReturning(pointcut = "@annotation(es.caib.sistrahelp.core.interceptor.NegocioInterceptor)", returning = "retVal")
	 ...
	 *            Exception
	 */
	@AfterThrowing(pointcut = "@annotation(es.caib.sistrahelp.core.interceptor.NegocioInterceptor)", throwing = "ex")
