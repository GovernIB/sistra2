...
public class TestController {
	...
	public void nuevo() {
		// Muestra dialogo
		UtilJSF.openDialog(TestDialogController.VIEW_NAME, TypeModoAcceso.ALTA, null, true, 640, 340);
	}
	...
	public void editar() {
		...
		UtilJSF.openDialog(TestDialogController.VIEW_NAME, TypeModoAcceso.EDICION, params, true, 340, 140);
	...
	public void abrirDialogoExterno() {
		...
		UtilJSF.openDialog(TestDialogExternoController.VIEW_NAME, TypeModoAcceso.CONSULTA, null, true, 640, 340);
	}
