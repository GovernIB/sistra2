		...
		pinta = function() {
			...
			if (intrusiu === "si") {
				...
				if (settings.tipus !== "missatge") {
					...
					codi_modul += "<li><a class=\"bt bt-accepta bt-important\" href=\"javascript:;\"><span class=\"i\">&nbsp;</span><span class=\"t\">" + txtFormDinAccepta + "</span></a></li>";
					codi_modul += (settings.tipus === "confirmacio") ? "<li><a class=\"bt-cancela\" href=\"javascript:;\">" + txtFormDinCancela + "</a></li>" : "";
					codi_modul += "</ul>";
				}
				if (settings.tipus === "missatge" && settings.cancela === "si") {
					codi_modul += "<ul class=\"botonera\">";
					codi_modul += "<li><a class=\"bt-cancela\" href=\"javascript:;\">" + txtFormDinCancela + "</a></li>";
					codi_modul += "</ul>";
				}
				codi_modul += "</div>";
				codi_modul += "</div>";
				...
				codi_modul += "<p class=\"titol\">" + settings.titol + "</p>";
				codi_modul += (settings.text !== "") ? "<p class=\"text\">" + settings.text + "</p>" : "";
				codi_modul += "<p class=\"botonera\"><a class=\"bt bt-accepta\" href=\"javascript:;\" title=\"" + txtFormDinAccepta + "\"><span class=\"i\">&nbsp;</span></a><span class=\"temps\"></span></p>";
				codi_modul += "</div>";
				codi_modul += "</div>";
				codi_modul += "</li>";
			}
	...
	this.each(function(){
		...
		onClick = function() {
			...
			if (!element.hasClass("imc-select-on") && !element.find("a.imc-select:first").is(".imc-select-deshabilitat, .imc-select-lectura")) {
				...
				/*
				var window_H = imc_forms_contingut.height(),//$(window).height(),
					window_T = imc_forms_contingut.scrollTop(),//$(window).scrollTop(),
					element_T = (settings.posicio == "position") ? submenu_a.position().top : submenu_a.offset().top,
					element_L = (settings.posicio == "position") ? submenu_a.position().left : submenu_a.offset().left,
					element_H = submenu_a.outerHeight(),
					element_W = submenu_a.outerWidth(),
