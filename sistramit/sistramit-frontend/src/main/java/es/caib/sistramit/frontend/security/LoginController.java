...
public final class LoginController {
	...
	public ModelAndView login(final HttpServletRequest request, final HttpServletResponse response) {
		...
		if (!ConstantesSeguridad.PUNTOENTRADA_ACCESO_CLAVE.equals(puntoEntrada)) {
	...
	public ModelAndView accesoClave(final HttpServletRequest request, final HttpServletResponse response) {
		try {
	...
	public ModelAndView logoutClave(final @RequestParam(required = true) boolean logout,
	...
	private ModelAndView autenticarFormLogin(final SavedRequest savedRequest) {
		...
		if (filtroAutenticacion == TypeAutenticacion.ANONIMO) {
			...
			autenticado = infoLoginTramite.getNiveles().contains(TypeAutenticacion.AUTENTICADO);
			anonimo = infoLoginTramite.getNiveles().contains(TypeAutenticacion.ANONIMO);
		}
