...
public interface LiteralesFront {
    ...
    // Los literales de cada elemento comenzarán con el prefijo correspondiente.
     ...
     * @return Literal
     */
    String getLiteralFront(String elemento, String codigo, String[] parametros,
            String idioma);
