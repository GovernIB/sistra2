...
public final class Entidad implements ModelApi {
	 ...
	 */
	public void setUrlCarpeta(final String urlCarpeta) {
	 ...
	 */
	public void setSoporte(final EntidadSoporte soporte) {
	 ...
	 */
	public void setUrlMapaWeb(final String urlMapaWeb) {
	 ...
	 */
	public void setUrlAvisoLegal(final String urlAvisoLegal) {
	 ...
	 *                   urlRss a establecer
	 */
	public void setUrlRss(final String urlRss) {
		this.urlRss = urlRss;
	}
	 ...
	 *                  redes a establecer
	 */
	public void setRedes(final EntidadRedesSociales redes) {
		this.redes = redes;
	}
