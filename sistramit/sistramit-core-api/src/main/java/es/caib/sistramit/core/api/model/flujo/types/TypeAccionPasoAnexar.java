...
public enum TypeAccionPasoAnexar implements TypeAccionPaso {
	...
	/**
	 * Anexar documento. Parámetros entrada: idAnexo, nombreFichero, presentacion
	 * (TypePresentacion), datosFichero (byte[]), titulo. Parámetros salida:
	 * conversionPDF (true/false)
	 */
	ANEXAR_DOCUMENTO,
	/**
	 * Borra un anexo. Parámetros entrada: idAnexo, instancia. Parámetros salida: no
	 * tiene
	 */
	BORRAR_ANEXO,
	/**
