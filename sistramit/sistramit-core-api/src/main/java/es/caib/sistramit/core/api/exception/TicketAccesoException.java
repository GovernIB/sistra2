...
public final class TicketAccesoException extends ServiceRollbackException {
	 ...
	 *            Mensaje de error.
	 */
	public TicketAccesoException(final String pMessage) {
		super(pMessage);
	}
	 ...
	 *            Excepcion original.
	 */
	public TicketAccesoException(final String pMessage, final Throwable pExc) {
		super(pMessage, pExc);
	}
	 ...
	 */
	public TicketAccesoException(final String pMessage, final Throwable pCause,
