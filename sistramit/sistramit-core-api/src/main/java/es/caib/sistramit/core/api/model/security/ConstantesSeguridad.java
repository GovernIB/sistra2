...
public final class ConstantesSeguridad {
    ...
    /**
     * Atributo que indica que la sesion viene del login para que el autologout
     * no haga logout.
     */
