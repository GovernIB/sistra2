...
public final class AvisoPlataforma implements ModelApi {
     ...
     *            Bloquear acceso
     */
    public AvisoPlataforma(final String pMensaje,
            final boolean pBloquearAcceso) {
        super();
        mensaje = pMensaje;
     ...
     */
    public static AvisoPlataforma createNewAvisoPlataforma(
            final String pMensaje, final boolean pBloquearAcceso) {
