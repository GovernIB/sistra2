 ...
 *
 */
public interface GestorFormulariosInternoService {
     ...
     *         cliente
     */
    ResultadoEvaluarCambioCampo evaluarCambioCampoPagina(
     ...
     *         no ha pasado la validación y se ha generado un mensaje, etc. En
     *         caso de llegar al fin del formulario se indicará el ticket de
     *         acceso al XML y PDF generados.
     */
    ResultadoGuardarPagina guardarPagina(final String idSesionFormulario,
            List<ValorCampo> valoresPagina, final String accionPersonalizada);
     ...
     */
    List<ValorCampo> deserializarValoresCampos(String idSesionFormulario,
