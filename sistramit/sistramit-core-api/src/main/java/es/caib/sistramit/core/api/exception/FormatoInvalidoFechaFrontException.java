...
public final class FormatoInvalidoFechaFrontException
     ...
     *            excepción generada
     */
    public FormatoInvalidoFechaFrontException(final String fecha,
            final Throwable e) {
        super("Formato de fecha invalido: " + fecha, e);
    }
