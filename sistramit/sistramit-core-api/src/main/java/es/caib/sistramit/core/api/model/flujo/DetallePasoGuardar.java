...
public final class DetallePasoGuardar extends DetallePaso {
	 ...
	 * finalización del trámite. Este mensaje aparecerá al finalizar el trámite tras
	 * registrar.
	 */
	private String instruccionesTramitacion;

	/**
	 * Instrucciones de presentación (HTML): cuando haya que entregar documentación
	 * presencial pueden establecerse instrucciones de entrega específicas.
	 */
	private String instruccionesPresentacion;

	/**
	 * Instrucciones de subsanacion (HTML): cuando el trámite deba subsanarse pueden
	 * establecerse instrucciones de entrega específicas.
	 */
	 ...
	 */
	public void setInstruccionesPresentacion(final String instruccionesPresentacion) {
