...
public abstract class DocumentoFirmado extends Documento {
     ...
     * @return firmantes
     */
    public final List<Persona> getFirmantes() {
        return firmantes;
    }
     ...
     */
    public final void setFirmantes(final List<Persona> pFirmantes) {
     ...
     * @param nif
     *            Nif
     * @return Devuelve el orden que ocupa el firmante en caso de que el nif
     *         deba firmar el documento (empieza en 0). Devuelve -1 si no tiene
     *         que firmarlo.
     */
