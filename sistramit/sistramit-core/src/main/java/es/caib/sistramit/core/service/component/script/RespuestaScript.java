...
public final class RespuestaScript {
    ...
    /**
     * Valor retornado por el script: un string o un plugin de tipo resultado
     * (en caso de que el script retorne un valor).
     */
    ...
    /**
     * En caso de que se haya marcado un error se establece el mensaje del
     * error.
     */
    private String mensajeError;

    /**
     * Para los scripts de validación indica si hay que generar mensaje de
     * aviso. No para ejecución, simplemente se muestra mensaje.
     */
