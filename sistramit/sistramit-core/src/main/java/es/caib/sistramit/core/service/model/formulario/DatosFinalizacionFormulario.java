...
public final class DatosFinalizacionFormulario implements Serializable {
    ...
    /**
     * Indica si el ticket se ha usado para retornar el formulario.
     */
     ...
     * @return usadoRetorno
     */
    public final boolean isUsadoRetorno() {
        return usadoRetorno;
    }
     ...
     */
    public final void setUsadoRetorno(final boolean pUsadoRetorno) {
