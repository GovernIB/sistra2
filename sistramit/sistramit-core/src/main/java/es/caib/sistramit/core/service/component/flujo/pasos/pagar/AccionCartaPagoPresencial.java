...
public final class AccionCartaPagoPresencial implements AccionPaso {
    ...
    public RespuestaEjecutarAccionPaso ejecutarAccionPaso(DatosPaso pDatosPaso,
        ...
        final DatosSesionPago sesionPago = ControladorPasoPagarHelper
                .getInstance()
                .crearSesionPagoPasarela(TypePresentacion.PRESENCIAL,
                        pVariablesFlujo.getIdSesionTramitacion(), pDipa, idPago,
                        pVariablesFlujo.getIdioma(), pDefinicionTramite);
        final byte[] cartaPago = pagoExternoComponent
                .obtenerCartaPagoPresencial(sesionPago,
        ...
        actualizarPersistencia(pDipa, pDpp, idPago, sesionPago,
                pVariablesFlujo.getIdSesionTramitacion(), cartaPago);
    ...
    private void validacionesPago(final DatosInternosPasoPagar pDipa,
        ...
        if (!pPago.getPresentacionesPermitidas()
                .contains(TypePresentacion.PRESENCIAL)) {
    ...
    private void actualizarPersistencia(final DatosInternosPasoPagar pDipa,
            ...
            final String pIdSesionTramitacion, byte[] cartaPago) {
        ...
        final ReferenciaFichero referenciaCartaPago = dao
                .insertarFicheroPersistencia(idPago + ".pdf", cartaPago,
                        pIdSesionTramitacion);
