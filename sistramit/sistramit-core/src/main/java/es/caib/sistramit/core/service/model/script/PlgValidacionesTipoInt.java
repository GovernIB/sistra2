...
public interface PlgValidacionesTipoInt {
	 ...
	 * @param dc
	 *                     Codigo de 2 digitos correspondiente a los digitos de
	 *                     control
	 * @param cuenta
	 ...
	 *
	 * @param fechaUno
	 *                         Parámetro fecha uno (formato fecha por defecto:
	 *                         yyyy-MM-dd)
	 * @param fechaDos
	 *                         Parámetro fecha dos (formato fecha por defecto:
	 *                         yyyy-MM-dd)
	 * @param formatoFecha
	 *                         Formato de fecha (si no se pasa, el formato por
	 *                         defecto sera yyyy-MM-dd)
	 ...
	 *
	 * @param fecha
	 *                         Parámetro fecha (formato fecha por defecto:
	 *                         yyyy-MM-dd)
	 * @param formatoFecha
	 *                         Formato de fecha (si no se pasa, el formato por
	 *                         defecto sera yyyy-MM-dd)
	 ...
	 * @param formatoFecha
	 *                         Formato de fecha (si no se pasa, el formato por
	 *                         defecto sera yyyy-MM-dd HH:mm:ss)
	 * @return Devuelve (0) en caso de que la fecha sea igual, (1) en el caso de que
	 *         la fecha sea superior a la actual y (-1) si la fecha es inferior a la
	 *         actual
	 * @throws ValidacionTipoException
	 ...
	 *                               Parámetro separador decimales (. o ,).
	 *                               Obligatorio.
	 * @return el double
	 * @throws ValidacionTipoException
	 */
	 ...
	 *                               Parámetro separador miles (. o ,). Opcional.
	 * @param separadorDecimales
	 *                               Parámetro separador decimales (. 0 ,).
	 *                               Obligatorio.
	...
	/**
	 * Convierte a formato fecha defecto.
	 *
	 * @param fecha
	 *                    Fecha
	 * @param formato
	 *                    Formato fecha entrada
	 * @return Fecha en formato defecto
	 */
	String convierteFechaFormatoDefecto(String fecha, String formato) throws ValidacionTipoException;

	/**
	 * Convierte a formato fecha hora defecto.
	 *
	 * @param fecha
	 *                    Fecha
	 * @param formato
	 ...
	 * @return Fecha en formato defecto
	 */
	String convierteFechaHoraFormatoDefecto(String fecha, String formato) throws ValidacionTipoException;
