...
public final class ResDatosInicialesFormulario implements ResDatosInicialesFormularioInt {
	/**
	...
	@Override
	public void setValor(final String campo, final String valor) throws ScriptException {
	...
	@Override
	public void setValorCompuesto(final String campo, final String codigo, final String descripcion)
			throws ScriptException {
		final ValorCampoIndexado vc = new ValorCampoIndexado(campo, codigo, descripcion);
		validarCampo(vc);
		datosIniciales.add(vc);
	}

	@Override
	public void setValorMultiple(final String campo, final ClzValorCampoMultipleInt valores) throws ScriptException {
		final ValorCampoListaIndexados valorInicial = ScriptUtils.crearValorListaIndexados(campo, valores);
	...
	@Override
	public void setValorListaElementos(final String campo, final ClzValorCampoListaElementosInt valores)
			throws ScriptException {
		final ValorCampoListaElementos valorInicial = ScriptUtils.crearValorListaElementos(campo, valores);
		validarCampo(valorInicial);
		datosIniciales.add(valorInicial);
	...
	private void validarCampo(final ValorCampo vs) throws ScriptException {
		if (!UtilsFormulario.comprobarCaracteresPermitidos(vs)) {
			throw new ScriptException("Valor camp conté caràcters no permesos: " + vs.print());
		}
	}
}
