...
public interface EnvioRemotoComponent {
     ...
     * @param idEnvioRemoto id Envio Remoto
     ...
     * @param idEntidad           id Entidad
     * @param idEnvioRemoto       id Envio Remoto
     * @param idSesionEnvio       id sesion envío
     * @param idSesionTramitacion id sesion tramitacion
     * @param datosTramitacion    datos tramitacion
    ...
    ResultadoRegistrar realizarEnvio(String idEntidad, String idEnvioRemoto, String idSesionTramitacion,
                                     String idSesionEnvio, DatosTramitacion datosTramitacion,
