...
public interface DominiosResolucionComponent {
     ...
     * @return
     */
    ValoresDominio resuelveDominioFD(final RDominio dominio);
     ...
     * @return
     */
    ValoresDominio resuelveDominioSQL(final RDominio dominio,
     ...
     * @return
     */
    ValoresDominio resuelveDominioWS(final RDominio dominio,
            final ParametrosDominio parametrosDominio);
