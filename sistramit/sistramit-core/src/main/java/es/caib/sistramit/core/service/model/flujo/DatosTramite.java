...
public final class DatosTramite implements Serializable {
	...
	/**
	 * Indica si el plazo se ha establecido de forma dinámica a través del script de
	 * personalización del trámite. En este caso no se tomarán en cuenta los plazos
	 * provinientes del catálogo de procedimientos.
	 */
	 ...
	 */
	private final List<DatosPaso> datosPasos = new ArrayList<DatosPaso>();

	/**
	 * Identificador del paso actual. En caso de ser nulo implicará que el trámite
	 * se esta iniciando o se esta cargando.
	 */
	private String idPasoActual;

	/**
	 * Identificador del paso siguiente. Se calculará tras ir a un paso o despues de
	 * ejecutar la accion sobre un paso.
	 */
	 ...
	 */
	private final Map<String, Boolean> accesibilidadPasos = new HashMap<String, Boolean>();
	 ...
	 */
	private List<TypeAutenticacion> metodosLogin = new ArrayList<TypeAutenticacion>();
	...
	public List<DatosPaso> getDatosPasos(final TypePaso tipoPaso) {
		final List<DatosPaso> res = new ArrayList<DatosPaso>();
		for (final DatosPaso dp : this.datosPasos) {
	...
	public DatosPaso getDatosPasoUltimo() {
		final DatosPaso dp = this.getDatosPasos().get(this.getDatosPasos().size() - ConstantesNumero.N1);
		return dp;
	}
	 ...
	 */
	public void setNivelAutenticacionFlujo(final TypeAutenticacion pNivelAutenticacionFlujo) {
