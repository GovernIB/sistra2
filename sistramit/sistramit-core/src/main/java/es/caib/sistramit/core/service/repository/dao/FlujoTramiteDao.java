...
public interface FlujoTramiteDao {
     ...
     */
    DatosPersistenciaTramite obtenerTramitePersistencia(
     ...
     */
    boolean verificaTimestampFlujo(String idSesionTramitacion,
            Date timestampFlujo);
     ...
     *
     */
    void cambiaEstadoTramite(String idSesionTramitacion,
            TypeEstadoTramite estado);

    /**
     * Crea un paso asociado al trámite, dejandolo como pendiente de
     * inicializar.
     *
     * @param idSesionTramitacion
     *            Id sesión tramitación
     ...
     *            Parámetro orden
     */
    void crearPaso(String idSesionTramitacion, String idPaso, TypePaso tipoPaso,
            int orden);
     ...
     */
    List<EstadoPersistenciaPasoTramite> obtenerListaPasos(
            String idSesionTramitacion);
     ...
     */
    Long contadorLimiteTramitacion(final String idTramite, final int version,
            int limiteIntervalo, final Date finIntervalo);
