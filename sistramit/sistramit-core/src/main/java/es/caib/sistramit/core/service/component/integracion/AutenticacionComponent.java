...
public interface AutenticacionComponent {
    ...
    String iniciarSesionAutenticacion(String codigoEntidad, String idioma,
            List<TypeAutenticacion> metodos, String qaa, String callback,
     ...
     * @return
     */
    String iniciarSesionLogout(String codigoEntidad, String pIdioma,
            String pCallback, boolean pDebugEnabled);
