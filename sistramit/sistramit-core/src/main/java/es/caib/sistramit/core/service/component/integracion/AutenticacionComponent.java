...
public interface AutenticacionComponent {
	 ...
	 */
	String iniciarSesionAutenticacion(String codigoEntidad, String idioma, String metodos, String qaa, String callback,
	 ...
	 */
	DatosAutenticacionUsuario validarTicketAutenticacion(String pTicket, boolean pDebug);
