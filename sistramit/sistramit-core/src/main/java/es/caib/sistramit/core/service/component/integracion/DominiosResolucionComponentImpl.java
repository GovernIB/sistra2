...
public final class DominiosResolucionComponentImpl
        implements DominiosResolucionComponent {
     ...
     */
    @Override
    public ValoresDominio resuelveDominioFD(final RDominio dominio) {
        final RValoresDominio rvalores = sistragesApiComponent
                .resuelveDominioFuenteDatos(dominio);
    ...
    public ValoresDominio resuelveDominioLF(final RDominio dominio) {
        final RValoresDominio valores = sistragesApiComponent
                .resuelveDominioListaFija(dominio);
     ...
     * @return
     */
    private ValoresDominio convertToValoresDominio(
            final RValoresDominio rvalores) {
     ...
     */
    @Override
    public ValoresDominio resuelveDominioSQL(final RDominio dominio,
            final ParametrosDominio parametrosDominio) {
        return dominioDao.realizarConsultaBD(dominio.getUri(), dominio.getSql(),
                parametrosDominio);
    }
     ...
     */
    @Override
    public ValoresDominio resuelveDominioWS(final RDominio dominio,
            final ParametrosDominio parametrosDominio) {
        ...
        if (iplugin == null) {
            ...
            try {
                ...
                final es.caib.sistra2.commons.plugins.dominio.api.ValoresDominio rvalores = iplugin
                        .invocarDominio(dominio.getIdentificador(),
                                dominio.getUri(), parametros);
                valoresDominio = new ValoresDominio();
                valoresDominio.setCodigoError(rvalores.getCodigoError());
                valoresDominio.setDatos(rvalores.getDatos());
                valoresDominio
                        .setDescripcionError(rvalores.getDescripcionError());
