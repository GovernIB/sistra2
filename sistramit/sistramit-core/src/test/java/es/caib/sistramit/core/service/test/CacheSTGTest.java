...
public class CacheSTGTest extends BaseDbUnit {
    ...
    public void test1_cache() {
        ...
        confEntidad = sistragesComponent
                .obtenerConfiguracionEntidad(SistragesMock.ID_ENTIDAD);
        ...
        avisosEntidad = sistragesComponent
                .obtenerAvisosEntidad(SistragesMock.ID_ENTIDAD);
        ...
        defTramite = sistragesComponent.recuperarDefinicionTramite(
                SistragesMock.ID_TRAMITE, SistragesMock.VERSION_TRAMITE,
                SistragesMock.IDIOMA);
        timestamp2 = defTramite.getTimestamp();
        Assert.isTrue(timestamp1.equals(timestamp2), "No coincide timestamp");
        sistragesComponent.evictDefinicionTramite(SistragesMock.ID_TRAMITE,
                SistragesMock.VERSION_TRAMITE, SistragesMock.IDIOMA);
        defTramite = sistragesComponent.recuperarDefinicionTramite(
                SistragesMock.ID_TRAMITE, SistragesMock.VERSION_TRAMITE,
                SistragesMock.IDIOMA);
