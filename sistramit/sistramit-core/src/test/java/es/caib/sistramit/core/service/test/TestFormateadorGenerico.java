    ...
    public static void main(final String args[]) throws Exception {
        ...
        final InputStream inputStream = Thread.currentThread()
                .getContextClassLoader().getResourceAsStream(
                        "formateador/generico/formularioInternoTest.json");
        ...
        mapper.configure(
                ...
                false);
        final RFormularioInterno formularioInterno = mapper
                .readValue(formularioInternoJSON, RFormularioInterno.class);
        ...
        pValores.add(new ValorCampoSimple("ID_1538490534185",
                "Univ. Politécnica de València"));
        pValores.add(new ValorCampoIndexado("ID_1538557979878", "ITIG",
                "Ingeniero tec. informática de gestión"));
        pValores.add(new ValorCampoSimple("ID_1540219071464",
                "C1 en Inglés, B2 en francés"));
        pValores.add(new ValorCampoSimple("ID_1540219110471", "Sí"));

        // Sección spam
        pValores.add(
                new ValorCampoSimple("ID_1540220994236", "inventado@indra.es"));
        pValores.add(
                new ValorCampoIndexado("ID_1540221034402", "ES", "Castellano"));
        ...
        pValores.add(new ValorCampoSimple("ID_1540219032190",
                "inventado.personal@indra.es"));

        formulario.setValores(pValores);

        final InputStream inputpropiedad = Thread.currentThread()
        ...
        final byte[] resultado = formateador.formatear(
                UtilsFormulario.valoresToXml(formulario),
                SerializationUtils.serialize(properties), "es",
                formularioInterno, "Título del procedimiento");
