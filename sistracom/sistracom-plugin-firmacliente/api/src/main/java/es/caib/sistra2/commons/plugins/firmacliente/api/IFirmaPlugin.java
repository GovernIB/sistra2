...
public interface IFirmaPlugin extends IPlugin {
	...
	/** Prefix. */
	public static final String FIRMACLIENTE_BASE_PROPERTY = IPLUGINSIB_BASE_PROPERTIES + "firmacliente.";

	/**
	 * Permite generar una sesión de firma.
	 *
	 * @param infoSesionFirma
	 *                            Datos relativos a la sesión de firma, como son el
	 *                            idioma, el código de entidad, el NIF del firmante,
	 *                            nombre de usuario firmante, código SIA del
	 *                            procedimiento,
	 ...
	 * @throws FirmaPluginException
	 */
	void anyadirFicheroAFirmar(FicheroAFirmar ficheroAFirmar) throws FirmaPluginException;
	 ...
	 *                          la pasarela de firma deberá invocar una vez
	 *                          finalizada la realización de la firma.
	 * @param paramAdic
	...
	/**
	 * Indica si se deben verificar las firmas mediante plugin de validación tras
	 * firmarse.
	 *
	 * @return boolean
	 */
