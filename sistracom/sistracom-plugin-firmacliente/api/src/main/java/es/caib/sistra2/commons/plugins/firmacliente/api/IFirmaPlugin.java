...
public interface IFirmaPlugin extends IPlugin {
    ...
    /** Prefix. */
    public static final String FIRMACLIENTE_BASE_PROPERTY = IPLUGINSIB_BASE_PROPERTIES
            + "firmacliente.";
     ...
     */
    String generarSesionFirma(InfoSesionFirma infoSesionFirma)
            throws FirmaPluginException;
     ...
     * @param urlCallBack
     *            URL de callback de la aplicación invocante a la que la
     *            pasarela de firma deberá invocar una vez finalizada la
     *            realización de la firma.
     * @param paramAdic
     *            parámetros adicionales según pasarela de firma
     * @return urlPasarelaFirma : URL a la que se deberá redirigir el navegador
     *         del usuario para ir la pasarela de firma
     *
     */
    String iniciarSesionFirma(String idSesionFirma, String urlCallBack,
            String paramAdic) throws FirmaPluginException;
     ...
     */
    TypeEstadoFirmado obtenerEstadoSesionFirma(String idSesionFirma)
            throws FirmaPluginException;
     ...
     * @return
     */
    FicheroFirmado obtenerFirmaFichero(String idSesionFirma,
            String idFicheroFirma) throws FirmaPluginException;
