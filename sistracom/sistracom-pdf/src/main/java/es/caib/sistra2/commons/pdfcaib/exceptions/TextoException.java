...
public class TextoException extends Exception{
   ...
   * @param cause Causa
   */
  public TextoException(final String message, final Throwable cause) {
    super(message, cause);
  }
  /**
   * Constructor.
   ...
   * @param message Mensaje
   */
  public TextoException(final String message) {
    super(message);
  }
   ...
   *
   */
  public TextoException(final String codigoError, final String mensajeError) {
    super();
