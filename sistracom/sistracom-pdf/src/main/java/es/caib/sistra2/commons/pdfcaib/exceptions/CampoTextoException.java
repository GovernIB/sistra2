 ...
 *
 */
public class CampoTextoException extends Exception{
   ...
   * @param cause Causa
   */
  public CampoTextoException(final String message, final Throwable cause) {
    super(message, cause);
  }
  /**
   * Constructor.
   ...
   * @param message Mensaje
   */
  public CampoTextoException(final String message) {
    super(message);
  }
   ...
   *
   */
  public CampoTextoException(final String codigoError, final String mensajeError) {
    super();
