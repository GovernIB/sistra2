 ...
 *
 */
public class CampoCheckException extends Exception{
   ...
   * @param cause Causa
   */
  public CampoCheckException(final String message, final Throwable cause) {
    super(message, cause);
  }
  /**
   * Constructor.
   ...
   * @param message Mensaje
   */
  public CampoCheckException(final String message) {
    super(message);
  }
   ...
   *
   */
  public CampoCheckException(final String codigoError, final String mensajeError) {
    super();
