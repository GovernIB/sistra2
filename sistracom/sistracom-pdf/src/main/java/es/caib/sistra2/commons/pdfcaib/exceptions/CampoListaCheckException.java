 ...
 *
 */
public class CampoListaCheckException extends Exception{
   ...
   * @param cause Causa
   */
  public CampoListaCheckException(final String message, final Throwable cause) {
    super(message, cause);
  }
  /**
   * Constructor.
   ...
   * @param message Mensaje
   */
  public CampoListaCheckException(final String message) {
    super(message);
  }
   ...
   *
   */
  public CampoListaCheckException(final String codigoError, final String mensajeError) {
    super();
