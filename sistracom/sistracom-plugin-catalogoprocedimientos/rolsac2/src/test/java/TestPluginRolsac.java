...
import es.caib.sistra2.commons.plugins.catalogoprocedimientos.rolsac2.CatalogoProcedimientosRolsacPlugin;

public class TestPluginRolsac {

	public static void main(final String[] args) throws Exception {

		final String classname = "es.caib.sistra2.commons.plugins.catalogoprocedimientos.rolsac2.CatalogoProcedimientosRolsacPlugin";
		final String prefijoGlobal = "es.caib.sistra2.";
		final String prefijoPlugin = "pluginsib.catalogoprocedimientos.rolsac2.";

		final Properties prop = new Properties();
		prop.put(prefijoGlobal + prefijoPlugin + "usr", "u83491");
		prop.put(prefijoGlobal + prefijoPlugin + "pwd", "C4mp30n@s");
