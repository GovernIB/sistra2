...
public final class RFicheroDominio implements Serializable {
     ...
     *            Contenido b64
     */
    public RFicheroDominio(final String pNombre, final String pContenidoB64) {
        super();
        nombre = pNombre;
