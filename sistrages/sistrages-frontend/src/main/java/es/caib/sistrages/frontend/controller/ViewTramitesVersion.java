...
public class ViewTramitesVersion extends ViewControllerBase {
    ...
    public void init() {
        ...
        UtilJSF.verificarAccesoAdministradorDesarrolladorEntidadByArea(
                area.getCodigo());
    ...
    private void checkPermiteArea() {
        ...
        if (UtilJSF.getSessionBean()
            ...
            // Si no es desarrollo, desactivar seguro el area para alta y
            // editar.
            if (UtilJSF.checkEntorno(TypeEntorno.DESARROLLO)) {

                this.permiteAltaArea = permisos
                        .contains(TypeRolePermisos.ADMINISTRADOR_AREA)
                        || permisos
                                .contains(TypeRolePermisos.DESARROLLADOR_AREA);

                this.permiteEliminarArea = permisos
                        .contains(TypeRolePermisos.ADMINISTRADOR_AREA)
                        || permisos
                                .contains(TypeRolePermisos.DESARROLLADOR_AREA);
                this.permiteEditarArea = permisos
                        .contains(TypeRolePermisos.ADMINISTRADOR_AREA)
                        || permisos
                                .contains(TypeRolePermisos.DESARROLLADOR_AREA);
                this.permiteConsultarArea = permisos
    ...
    public void editar() {
        ...
        params.put(TypeParametroVentana.ID.toString(),
                Arrays.asList(datoSeleccionado.getCodigo().toString()));
    ...
    public void desbloquear() {
        ...
        if (!permiteEditar || (UtilJSF.getSessionBean()
                .getActiveRole() == TypeRoleAcceso.DESAR
                && !this.datoSeleccionado.getDatosUsuarioBloqueo()
    ...
    public void duplicar() {
        ...
        this.tramiteService.clonadoTramiteVersion(
                this.datoSeleccionado.getCodigo(),
                UtilJSF.getSessionBean().getUserName());
    ...
    public void eliminar() {
        ...
        // Eliminamos
        this.tramiteService
                .removeTramiteVersion(this.datoSeleccionado.getCodigo());
     ...
     */
    public void filtrar() {
        listaDatos = tramiteService.listTramiteVersion(Long.valueOf(id),
                this.filtro);
    }
