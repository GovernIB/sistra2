...
@ManagedBean
@ViewScoped
public class DialogVariablesAreaFormulariosExternos extends DialogControllerBase {
	...
	/** listaDominios. **/
	private List<GestorExternoFormularios> listaGfe;
	...
	public void init() {
		...
		campos = new ArrayList<GestorExternoFormularios>();
		listaGfe = vaService.gfeByVariable(data);
		buscarDominios();
	}

	private void buscarDominios() {
		for (GestorExternoFormularios gfe : listaGfe) {
			campos.add(gfe);
		}
	}
	...
	public void consultarTramite() {
		...
		UtilJSF.openDialog(DialogDominio.class, TypeModoAcceso.CONSULTA, params, true, 770, 450);
	 ...
	 * @return the campos
	 */
	public List<GestorExternoFormularios> getListaGfe() {
		return listaGfe;
	}
	 ...
	 */
	public void setListaGfe(final List<GestorExternoFormularios> listaGfe) {
		this.listaGfe = listaGfe;
	}
	 ...
	 * @return the campos
	 */
	public final List<GestorExternoFormularios> getCampos() {
		return campos;
	}
	 ...
	 * @param campos the campos to set
	 */
	public final void setCampos(List<GestorExternoFormularios> campos) {
		this.campos = campos;
	}
