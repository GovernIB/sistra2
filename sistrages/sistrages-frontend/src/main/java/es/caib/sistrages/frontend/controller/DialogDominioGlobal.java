...
import es.caib.sistrages.core.api.model.DominioGlobal;
...
@ManagedBean
@ViewScoped
public class DialogDominioGlobal extends DialogControllerBase {

	/**
	 * Servicio.
	 */
	// @Inject
	// private DominioGlobalService dominioGlobalService;
	...
	public void init() {
		...
		if (modo == TypeModoAcceso.ALTA) {
			data = new DominioGlobal();
		} else {
			data = new DominioGlobal();// dominioGlobalService.load(id);
	...
	public DominioGlobal getData() {
		return data;
	}

	public void setData(final DominioGlobal data) {
		this.data = data;
	}
