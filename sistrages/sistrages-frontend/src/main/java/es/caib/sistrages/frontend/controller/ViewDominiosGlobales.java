...
public class ViewDominiosGlobales extends ViewControllerBase {
	 ...
	 */
	public void nuevo() {
		UtilJSF.openDialog(DialogDominioGlobal.class, TypeModoAcceso.ALTA, null, true, 700, 570);
	}
	...
	public void editar() {
		...
		UtilJSF.openDialog(DialogDominioGlobal.class, TypeModoAcceso.EDICION, params, true, 700, 570);
	}
