...
public class DialogDisenyoFormulario extends DialogControllerBase {
    ...
    public void init() {
        ...
        if (StringUtils.isNotEmpty(idTramiteVersion)) {
            tramiteVersion = tramiteService
                    .getTramiteVersion(Long.valueOf(idTramiteVersion));
    ...
    private void recuperarFormulario(final String idForm) {
        formulario = formIntService
                .getFormularioInternoCompleto(Long.parseLong(idForm));
    ...
    public void editarComponente() {
        ...
        if (objetoFormularioEdit != null && StringUtils.isNotEmpty(idComponente)
                && !objetoFormularioEdit.getCodigo()
                        .equals(Long.valueOf(idComponente.replace("L", "")))) {
            ...
            if (objetoFormularioEdit instanceof LineaComponentesFormulario) {
                ofOriginal = formulario.getPaginas().get(paginaActual - 1)
                        .getLinea(objetoFormularioEdit.getCodigo());
            ...
            if (!UtilCoreApi.equalsModelApi(ofOriginal, objetoFormularioEdit)) {
                ...
                final RequestContext contextReq = RequestContext
                        .getCurrentInstance();
    ...
    private void cambiarEdicionComponente(final String idComponente) {
        ...
        if (idComponente != null) {
            ...
            if (idComponente.contains("L")) {
                ...
                cf = formulario.getPaginas().get(paginaActual - 1)
                        .getComponente(Long.parseLong(idComponente));
            }

            // Buscamos nuevo componente
            if (cf != null) {
                objetoFormularioEdit = (ObjetoFormulario) UtilCoreApi
                        .cloneModelApi(cf);
                // TODO PARA QUITAR
                if (!UtilCoreApi.equalsModelApi(cf, objetoFormularioEdit)) {
                    UtilJSF.addMessageContext(TypeNivelGravedad.ERROR,
                            "Componente clonado no coincide");
                }
            }
        }
        ...
        if (objetoFormularioEdit != null) {
            if (objetoFormularioEdit instanceof ComponenteFormulario) {
                switch (((ComponenteFormulario) objetoFormularioEdit)
                        .getTipo()) {
                case CAMPO_TEXTO:
                ...
                detalleComponenteUrl = "/secure/app/dialogDisenyoFormularioComponente"
                        + ((ComponenteFormulario) objetoFormularioEdit)
                                .getTipo()
                        + ".xhtml";
    ...
    public void aplicarCambios() {
        ...
        if (objetoFormularioEdit != null) {
            final PaginaFormulario pagina = formulario.getPaginas()
                    .get(paginaActual - 1);
            final LineaComponentesFormulario linea = pagina
                    .getLineaComponente(objetoFormularioEdit.getCodigo());

            if (objetoFormularioEdit instanceof ComponenteFormulario) {
                if (!linea.cabenComponentes(
                        (ComponenteFormulario) objetoFormularioEdit)) {
                    UtilJSF.addMessageContext(TypeNivelGravedad.WARNING,
                ...
                final ComponenteFormulario cfOriginal = pagina
                        .getComponente(objetoFormularioEdit.getCodigo());
                ...
                if (objetoFormularioEdit instanceof ComponenteFormularioCampoSelector) {
                    ...
                    if (TypeListaValores.DOMINIO
                            .equals(campo.getTipoListaValores())
                            && campo.getCodDominio() != null
                            && !dominioService.tieneTramiteVersion(
                                    campo.getCodDominio(),
                                    tramiteVersion.getCodigo())) {
                        dominioService.addTramiteVersion(campo.getCodDominio(),
                                tramiteVersion.getCodigo());
                    }
                }
                ...
                urlIframe = "FormRenderServlet?ts="
    ...
    public void editarTraduccionesTexto() {
        if (((ComponenteFormulario) objetoFormularioEdit).getTexto() == null) {
            ...
            traduccionesEdit = ((ComponenteFormulario) objetoFormularioEdit)
                    .getTexto();
        }
        UtilTraducciones.openDialogTraduccion(
                TypeModoAcceso.valueOf(modoAcceso),
                ((ComponenteFormulario) objetoFormularioEdit).getTexto(),
                idiomas, idiomas);
    }
    ...
    public void editarTraduccionesAyuda() {
        ...
        UtilTraducciones.openDialogTraduccion(
                TypeModoAcceso.valueOf(modoAcceso), traduccionesEdit, idiomas,
                idiomas);
    }
    ...
    public boolean isLVDominio() {
        ...
        if (objetoFormularioEdit instanceof ComponenteFormularioCampoSelector) {
            final ComponenteFormularioCampoSelector campo = (ComponenteFormularioCampoSelector) objetoFormularioEdit;
            resultado = TypeListaValores.DOMINIO
                    .equals(campo.getTipoListaValores());
        }
    ...
    public boolean isDominioLF() {
        ...
        if (campo.getCodDominio() != null) {
            final Dominio dominio = dominioService
                    .loadDominio(campo.getCodDominio());
    ...
    public void abrirPropiedadesFormulario() {
        ...
        params.put(TypeParametroVentana.ID.toString(),
                String.valueOf(formulario.getCodigo()));
        ...
        UtilJSF.openDialog(DialogPropiedadesFormulario.class,
                TypeModoAcceso.valueOf(modoAcceso), params, true, 950, 460);
    }
    ...
    public boolean getHabilitadoBtnObjDer() {
        ...
        return orden != 0
                ? orden < ConstantesDisenyo.NUM_MAX_COMPONENTES_LINEA
                        && orden < numObjetosLinea()
                : false;
    }
    ...
    private int getOrden() {
        ...
        if (objetoFormularioEdit != null) {
            if (objetoFormularioEdit instanceof LineaComponentesFormulario) {
                orden = ((LineaComponentesFormulario) objetoFormularioEdit)
                        .getOrden();
            } else if (objetoFormularioEdit instanceof ComponenteFormulario) {
                orden = ((ComponenteFormulario) objetoFormularioEdit)
                        .getOrden();
            }
        }
        return orden;
    ...
    public void returnDialogo(final SelectEvent event) {
        ...
        if (!respuesta.isCanceled()
            ...
            final DisenyoFormulario formularioNuevo = (DisenyoFormulario) respuesta
                    .getResult();
    ...
    private void insertaCampo(final TypeObjetoFormulario tipoCampo) {
        ...
        if (objetoFormularioEdit == null) {
            ...
            UtilJSF.addMessageContext(TypeNivelGravedad.WARNING,
                    UtilJSF.getLiteral("warning.componente.seleccionado"),
                    true);
        } else {
            if (objetoFormularioEdit instanceof LineaComponentesFormulario) {
            ...
            orden = UtilDisenyo.ordenInsercionComponente(linea,
                    ordenSeleccionado, posicionamiento);

            if (orden != null) {
                final ObjetoFormulario componente = formIntService
                        .addComponenteFormulario(tipoCampo, idPagina,
                                linea.getCodigo(), orden, posicionamiento);

                // actualizamos modelo
                pagina.getLineas().get(linea.getOrden() - 1).getComponentes()
                        .add(orden - 1, (ComponenteFormulario) componente);

                // actualizamos orden
                for (int i = orden + 1; i <= linea.getComponentes()
                        .size(); i++) {
    ...
    private void insertaLineaComponenteBloque(
        ...
        if (objetoFormularioEdit == null && !pagina.getLineas().isEmpty()) {
            ...
            if (objetoFormularioEdit != null) {
                ...
                if (objetoFormularioEdit instanceof LineaComponentesFormulario) {
                    ...
                    lineaSeleccionada = pagina.getLineaComponente(
                            objetoFormularioEdit.getCodigo());
                }
            ...
            ordenLinea = UtilDisenyo.ordenInsercionLinea(pagina,
                    lineaSeleccionada, posicionamiento);

            final ObjetoFormulario componente = formIntService
                    .addComponenteFormulario(tipoCampo, pagina.getCodigo(),
                            idLineaSeleccionada, ordenLinea, posicionamiento);

            // actualizamos modelo
            pagina.getLineas().add(ordenLinea - 1,
    ...
    public void eliminarObjetoFormulario() {
        if (objetoFormularioEdit instanceof LineaComponentesFormulario) {
            formIntService
                    .removeLineaFormulario(objetoFormularioEdit.getCodigo());

            // actualizamos modelo
            final List<LineaComponentesFormulario> lineasPagina = formulario
                    .getPaginas().get(paginaActual - 1).getLineas();
            ...
            for (int i = lineaSeleccionada.getOrden(); i <= lineasPagina
                    .size(); i++) {
                lineasPagina.get(i - 1).setOrden(i);
            }

        } else if (objetoFormularioEdit instanceof ComponenteFormulario) {
            formIntService.removeComponenteFormulario(
                    objetoFormularioEdit.getCodigo());

            // actualizamos modelo
            final ComponenteFormulario componenteSeleccionado = (ComponenteFormulario) objetoFormularioEdit;

            final LineaComponentesFormulario linea = formulario.getPaginas()
                    .get(paginaActual - 1)
                    .getLineaComponente(componenteSeleccionado.getCodigo());
            linea.getComponentes()
                    .remove(componenteSeleccionado.getOrden() - 1);
            for (int i = componenteSeleccionado.getOrden(); i <= linea
                    .getComponentes().size(); i++) {
                linea.getComponentes().get(i - 1).setOrden(i);
            }

            if (TypeObjetoFormulario.SECCION
                    .equals(componenteSeleccionado.getTipo())
    ...
    public void cambiarCampoTextoMultilinea() {
        ...
        if (campo.isNormalMultilinea()) {
            ...
            campoNuevo.setNumColumnas(
                    ConstantesDisenyo.TAM_MIN_COMPONENTE_MULTILINEA);

            if (linea.cabenComponentes(campoNuevo)) {
                campo.setNumColumnas(
                        ConstantesDisenyo.TAM_MIN_COMPONENTE_MULTILINEA);
        ...
        if (objetoFormularioEdit == null) {
            ...
            if (objetoFormularioEdit instanceof LineaComponentesFormulario) {
                ...
                if (objetoFormularioEdit instanceof ComponenteFormularioSeccion) {
                    ...
                    if (((ComponenteFormularioCampoTexto) objetoFormularioEdit)
                            .isNormalMultilinea()) {
    ...
    private void moverLinea(final String pPosicion) {
        ...
        if (objetoFormularioEdit == null) {
            ...
            orden = UtilDisenyo.ordenMoverLinea(pagina, ordenSeleccionado,
                    pPosicion);

            if (orden != null) {
                final LineaComponentesFormulario lineaSeleccionado = pagina
                        .getLineas().get(ordenSeleccionado - 1);
                final LineaComponentesFormulario lineaCambiable = pagina
                        .getLineas().get(orden - 1);

                formIntService.updateOrdenLineaFormulario(
                        lineaSeleccionado.getCodigo(), orden);
                formIntService.updateOrdenLineaFormulario(
                        lineaCambiable.getCodigo(), ordenSeleccionado);
    ...
    private void moverComponente(final String pPosicion) {
        ...
        if (objetoFormularioEdit == null) {
            ...
            orden = UtilDisenyo.ordenMoverComponente(linea, ordenSeleccionado,
                    pPosicion);

            if (orden != null) {
                final ComponenteFormulario componenteSeleccionado = linea
                        .getComponentes().get(ordenSeleccionado - 1);
                final ComponenteFormulario componenteCambiable = linea
                        .getComponentes().get(orden - 1);

                formIntService.updateOrdenComponenteFormulario(
                        componenteSeleccionado.getCodigo(), orden);
                formIntService.updateOrdenComponenteFormulario(
                        componenteCambiable.getCodigo(), ordenSeleccionado);
    ...
    public void abrirListaValoresFijaCIN() {
        if (objetoFormularioEdit instanceof ComponenteFormularioCampoSelector) {
            ...
            if (!campo.getListaValorListaFija().isEmpty()) {
                mochilaDatos.put(Constantes.CLAVE_MOCHILA_LVFCIN,
                        campo.getListaValorListaFija().stream()
                                .map(SerializationUtils::clone)
                                .collect(java.util.stream.Collectors.toList()));
            }

            UtilJSF.openDialog(DialogListaValoresFijaCIN.class,
                    TypeModoAcceso.valueOf(modoAcceso), null, true, 800, 350);
        }
    }
        ...
        if (!respuesta.isCanceled()
            ...
            if (objetoFormularioEdit instanceof ComponenteFormularioCampoSelector) {
                ...
                if (respuesta.getResult() == null) {
                    ...
                    campo.setListaValorListaFija(
                            (List<ValorListaFija>) respuesta.getResult());
                }
            }
        } else {
            UtilJSF.doValidationFailed();
    ...
    public void abrirBusquedaDominio() {
        ...
        params.put(TypeParametroVentana.TRAMITE.toString(),
                String.valueOf(tramiteVersion.getIdTramite()));
        UtilJSF.openDialog(DialogBusquedaDominio.class,
                TypeModoAcceso.valueOf(modoAcceso), params, true, 1200, 420);
    }
    ...
    public void returnDialogoBusquedaDominio(final SelectEvent event) {
        ...
        if (!respuesta.isCanceled()
            ...
            if (!dominioService.tieneTramiteVersion(campo.getCodDominio(),
                    tramiteVersion.getCodigo())) {
    ...
    public void consultaDominio() {
        ...
        final Map<String, String> params = new HashMap<>();
        params.put(TypeParametroVentana.ID.toString(),
                String.valueOf(campo.getCodDominio()));
        params.put(TypeParametroVentana.AMBITO.toString(),
                dominio.getAmbito().toString());
        if (TypeAmbito.AREA.equals(dominio.getAmbito())) {
            final Area area = tramiteService
                    .getAreaTramite(tramiteVersion.getIdTramite());
            params.put(TypeParametroVentana.AREA.toString(),
                    area.getCodigo().toString());
        }
        UtilJSF.openDialog(DialogDominio.class, TypeModoAcceso.CONSULTA, params,
                true, 770, 680);
    }
    ...
    public void abrirParametrosDominioCIN() {
        if (objetoFormularioEdit instanceof ComponenteFormularioCampoSelector) {
            ...
            mochilaDatos = UtilJSF.getSessionBean().getMochilaDatos();
            mochilaDatos.put(Constantes.CLAVE_MOCHILA_PARAMDOM,
                    dominio.getParametros().stream()
                            .map(SerializationUtils::clone)
                            .collect(java.util.stream.Collectors.toList()));

            // metemos datos en la mochila
            if (!campo.getListaParametrosDominio().isEmpty()) {
                mochilaDatos.put(Constantes.CLAVE_MOCHILA_PRDCIN,
                        campo.getListaParametrosDominio().stream()
                                .map(SerializationUtils::clone)
                                .collect(java.util.stream.Collectors.toList()));
            }

            UtilJSF.openDialog(DialogParametrosDominioCIN.class,
                    TypeModoAcceso.valueOf(modoAcceso), null, true, 800, 350);
        }
    }
        ...
        if (!respuesta.isCanceled()
            ...
            if (objetoFormularioEdit instanceof ComponenteFormularioCampoSelector) {
                ...
                if (respuesta.getResult() == null) {
                    ...
                    campo.setListaParametrosDominio(
                            (List<ParametroDominio>) respuesta.getResult());
                }
            }
        } else {
            UtilJSF.doValidationFailed();
     ...
     * Editar script
     */
    public void editarDialogScript(final String tipoScript,
            final Script script) {
            ...
            case EDICION:
                if (objetoFormularioEdit instanceof ComponenteFormularioCampo) {
                    ((ComponenteFormularioCampo) objetoFormularioEdit)
                            .setScriptAutorrellenable(
                                    (Script) respuesta.getResult());
                }
                break;
            default:
                break;
    ...
    public void abrirDialogoEstructura() {
        ...
        UtilJSF.openDialog(DialogEstructuraFormulario.class,
                TypeModoAcceso.valueOf(modoAcceso), params, true, 450, 460);
    }
    ...
    public String getUrlIframe() {
        ...
        return urlIframe + "&id=" + id + "&page=" + paginaActual + "&lang="
                + idioma
