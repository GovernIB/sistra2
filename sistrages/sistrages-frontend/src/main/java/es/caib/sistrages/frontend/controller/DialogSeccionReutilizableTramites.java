...
@ManagedBean
@ViewScoped
public class DialogSeccionReutilizableTramites extends DialogControllerBase {
	...
	/** Campos. **/
	private List<SeccionReutilizableTramite> campos;

	/** Campos en formato JSON. **/
	private String iCampos;

	/** Fila seleccionada. **/
	private SeccionReutilizableTramite valorSeleccionado;
	...
	public void init() {
		...
		data = seccionReutService.getSeccionReutilizable(Long.valueOf(id));
		campos = tramiteService.getTramiteVersionBySeccionReutilizable(Long.valueOf(id));
	 ...
	 */
	public SeccionReutilizableTramite getValorSeleccionado() {
	 ...
	 */
	public void setValorSeleccionado(final SeccionReutilizableTramite valorSeleccionado) {
	 ...
	 * @return the campos
	 */
	public List<SeccionReutilizableTramite> getCampos() {
		return campos;
	}
	 ...
	 */
	public void setCampos(final List<SeccionReutilizableTramite> campos) {
		this.campos = campos;
	}
