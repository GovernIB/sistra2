...
public class DialogDominio extends DialogControllerBase {
    ...
    public void init() {
        ...
        if (typeAmbito == TypeAmbito.AREA) {
            fuentes = dominioService.listFuenteDato(TypeAmbito.AREA,
                    Long.valueOf(idArea), null);
        }
        if (typeAmbito == TypeAmbito.ENTIDAD) {
            fuentes = dominioService.listFuenteDato(TypeAmbito.ENTIDAD,
                    UtilJSF.getIdEntidad(), null);
        }
        ...
        if (!respuesta.isCanceled()) {
            ...
            case ALTA:
                if (isDialogoPropiedad) {
                    // Refrescamos datos
                    final Propiedad propiedad = (Propiedad) respuesta
                            .getResult();
            ...
            case EDICION:
                if (isDialogoPropiedad) {
                    ...
                    final Propiedad propiedadEdicion = (Propiedad) respuesta
                            .getResult();
                    // Muestra dialogo
                    final int posicion = this.data.getParametros()
                            .indexOf(this.propiedadSeleccionada);
                    ...
                    final Propiedad propiedadEdicion = (Propiedad) respuesta
                            .getResult();
                    // Muestra dialogo
                    final int posicion = this.data.getListaFija()
                            .indexOf(this.valorSeleccionado);
    ...
    public void nuevaPropiedad() {
        ...
        UtilJSF.openDialog(DialogPropiedad.class, TypeModoAcceso.ALTA, params,
                true, 430, 120);
    }
    ...
    public void nuevoValor() {
        ...
        UtilJSF.openDialog(DialogPropiedad.class, TypeModoAcceso.ALTA, null,
                true, 430, 120);
    }
    ...
    public void editarPropiedad() {
        ...
        params.put("OCULTARVALOR", "S");
        UtilJSF.openDialog(DialogPropiedad.class, TypeModoAcceso.EDICION,
                params, true, 430, 100);
    }
    ...
    public void editarValor() {
        ...
        final Map<String, String> params = new HashMap<>();
        params.put(TypeParametroVentana.DATO.toString(),
                UtilJSON.toJSON(this.valorSeleccionado));
        UtilJSF.openDialog(DialogPropiedad.class, TypeModoAcceso.EDICION,
                params, true, 430, 120);
    }
    ...
    public void aceptar() {
        ...
        if (this.data.getTipo() == TypeDominio.FUENTE_DATOS) {
            final FuenteDatos fuenteDato = dominioService
                    .loadFuenteDato(idFuenteDato);
        ...
        case ALTA:
            ...
            if (dominioService
                    .loadDominio(this.data.getIdentificador()) != null) {
                UtilJSF.addMessageContext(TypeNivelGravedad.ERROR,
                        UtilJSF.getLiteral("error.codigoRepetido"));
                return;
            }
            // Alta dominio
        ...
        case EDICION:
            // Verifica unicidad codigo dominio
            final Dominio d = dominioService
                    .loadDominio(this.data.getIdentificador());
            if (d != null && d.getCodigo().longValue() != this.data.getCodigo()
                    .longValue()) {
                UtilJSF.addMessageContext(TypeNivelGravedad.ERROR,
                        UtilJSF.getLiteral("error.codigoRepetido"));
                return;
            ...
            // usando y
            // mostrar mensaje
            if (!StringUtils.equals(this.data.getIdentificador(),
        ...
        if (identificadorCambiado) {
            ...
            dm.setMensaje(
                    "TODO:Pendiente controlar si se esta usando dominio para sacar aviso");
     ...
     */
    public void setPropiedadSeleccionada(
            final Propiedad propiedadSeleccionada) {
