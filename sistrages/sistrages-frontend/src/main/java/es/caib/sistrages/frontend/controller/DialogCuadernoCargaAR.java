...
@ManagedBean
@ViewScoped
public class DialogCuadernoCargaAR extends DialogControllerBase {

	/** Log. */
	private static final Logger LOGGER = LoggerFactory.getLogger(DialogCuadernoCargaAR.class);
	...
	public void init() {
		...
		if (data.getExiste() == TypeImportarExiste.EXISTE) {
			setMensaje(UtilJSF.getLiteral("dialogCuadernoCargaAR.estado.existedistinto"));
		} else {
			setMensaje(UtilJSF.getLiteral("dialogCuadernoCargaAR.estado.noexiste"));
		}
	}
