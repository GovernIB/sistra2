...
public class FormularioMockBD {
	...
	private static void init() {
		...
		final Traducciones txtNif = new Traducciones();
		...
		final Traducciones txtNom = new Traducciones();
		...
		final Traducciones txtApe = new Traducciones();
		...
		final Traducciones txtEmail = new Traducciones();
		...
		final Traducciones txtSelector = new Traducciones();
		...
		final Traducciones txtEtiq1 = new Traducciones();
