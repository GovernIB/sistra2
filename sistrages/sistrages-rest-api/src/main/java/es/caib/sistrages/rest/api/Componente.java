...
@JsonSubTypes({
        @Type(value = ComponenteSeccion.class, name = "ComponenteSeccion"),
        @Type(value = ComponenteAviso.class, name = "ComponenteAviso"),
        @Type(value = ComponenteTextbox.class, name = "ComponenteTextbox"),
        @Type(value = ComponenteSelector.class, name = "ComponenteSelector"),
        @Type(value = ComponenteCheckbox.class, name = "ComponenteCheckbox")})
