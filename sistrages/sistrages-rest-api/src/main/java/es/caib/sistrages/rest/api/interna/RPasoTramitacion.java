...
@JsonSubTypes({ @Type(value = RPasoTramitacionDebeSaber.class, name = "RPasoTramitacionDebeSaber"),
...
@ApiModel(value = "RPasoTramitacion", description = "Descripcion de RPasoTramitacion", subTypes = {
		RPasoTramitacionDebeSaber.class, RPasoTramitacionRellenar.class, RPasoTramitacionAnexar.class,
		RPasoTramitacionPagar.class, RPasoTramitacionRegistrar.class }, discriminator = "type")
public abstract class RPasoTramitacion {
	 ...
	 */
	public void setScriptNavegacion(final RScript scriptNavegacion) {
