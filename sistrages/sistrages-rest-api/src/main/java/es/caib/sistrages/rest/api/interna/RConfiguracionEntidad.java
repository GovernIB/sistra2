...
public class RConfiguracionEntidad {
	...
	/** Identificador (DIR3). */
	@ApiModelProperty(value = "Identificador (DIR3)")
	private String identificador;

	/** Código (identificador corto: GOIB, APB...). */
	@ApiModelProperty(value = "Identificador (DIR3)")
	...
	/** Contacto (HTML). */
	@ApiModelProperty(value = "Accesibilidad (HTML)")
	private RLiteral accesibilidadHTML;
	...
	/**
	 * @return the accesibilidadHTML
	 */
	public final RLiteral getAccesibilidadHTML() {
		return accesibilidadHTML;
	}

	/**
	 * @param accesibilidadHTML
	 *                              the accesibilidadHTML to set
	 */
	public final void setAccesibilidadHTML(final RLiteral accesibilidadHTML) {
		this.accesibilidadHTML = accesibilidadHTML;
	}
	 ...
	 *                   the titulo to set
	 */
	public final void setTitulo(final RLiteral titulo) {
		this.titulo = titulo;
	}
	 ...
	 *                  the icono to set
	 */
	public final void setIcono(final String icono) {
		this.icono = icono;
	}
