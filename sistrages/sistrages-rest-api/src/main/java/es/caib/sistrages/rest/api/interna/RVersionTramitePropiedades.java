...
public class RVersionTramitePropiedades {
	 ...
	 */
	public void setScriptPersonalizacion(final RScript scriptPersonalizacion) {
	 ...
	 */
	public void setScriptParametrosIniciales(final RScript scriptParametrosIniciales) {
