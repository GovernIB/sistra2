...
public class RConfiguracionGlobalAdapter {
    ...
    public void setrConfiguracionGlobal(
            RConfiguracionGlobal rConfiguracionGlobal) {
        this.rConfiguracionGlobal = rConfiguracionGlobal;
    }

    public RConfiguracionGlobalAdapter(List<ConfiguracionGlobal> cg,
            List<Plugin> pg) {
    ...
    private static RListaParametros toListaParametrosCG(
            List<ConfiguracionGlobal> cg) {
