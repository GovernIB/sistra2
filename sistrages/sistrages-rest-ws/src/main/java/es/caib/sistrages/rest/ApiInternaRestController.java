...
public class ApiInternaRestController {
    ...
    public RConfiguracionEntidad obtenerConfiguracionEntidad(
            @PathVariable("id") final String codigoDIR3) {
        final Entidad entidad = restApiService.loadEntidad(codigoDIR3);
        final List<FormularioSoporte> formSoporte = restApiService
                .listOpcionesFormularioSoporte(entidad.getCodigo());
    ...
    public RVersionTramite obtenerDefinicionVersionTramite(
            @PathVariable("idTramite") final String idtramite,
            @PathVariable("version") final int version,
            @PathVariable("idioma") final String idioma) throws Exception {
        ...
        return versionTramiteAdapter.convertir(idtramite, tv, idioma,
                idiomaDefecto);
    }
    ...
    public RAvisosEntidad obtenerAvisosEntidad(
            @PathVariable("id") final String idEntidad) {
    ...
    public RValoresDominio obtenerValoresDominioLF(
            @PathVariable("idDominio") final String idDominio) {

        final ValoresDominio res = restApiService
                .realizarConsultaListaFija(idDominio);
        return valoresDominioAdapter.convertir(res);
    }
