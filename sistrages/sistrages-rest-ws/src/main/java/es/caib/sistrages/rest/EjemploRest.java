...
public class EjemploRest {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@RolesAllowed(ConstantesRolesAcceso.SUPER_ADMIN)
	public RespuestaServerExample recuperaDato6BAckup(@FormParam("entity") final EntityExample entity,
	...
	@Produces(MediaType.APPLICATION_JSON)
	@RolesAllowed(ConstantesRolesAcceso.SUPER_ADMIN)
	public Response recuperaDato6(@FormParam("entity") final EntityExample entity,
			@FormParam("entity2") final EntityExample entity2) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@RolesAllowed(ConstantesRolesAcceso.SUPER_ADMIN)
	public RespuestaServerExample recuperaDato7(@FormParam("entity") final EntityExample entity,
			@FormParam("entity2") final EntityExample entity2) {
