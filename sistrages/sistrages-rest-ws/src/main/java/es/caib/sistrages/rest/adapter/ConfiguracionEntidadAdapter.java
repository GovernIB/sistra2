...
public class ConfiguracionEntidadAdapter {
     ...
     * @param idEntidad
     */
    public RConfiguracionEntidad convertir(Entidad idEntidad) {
    	 
        RConfiguracionEntidad rConfiguracionEntidad = new RConfiguracionEntidad();
        rConfiguracionEntidad.setTimestamp(System.currentTimeMillis() + "");
        rConfiguracionEntidad.setIdentificador(idEntidad.getCodigoDIR3() != null
                ? idEntidad.getCodigoDIR3().toString()
                : null);
        ...
        rConfiguracionEntidad
                .setContactoHTML(AdapterUtils.generarLiteral(idEntidad.getPie()));
        rConfiguracionEntidad.setUrlCarpeta(
                AdapterUtils.generarLiteral(idEntidad.getUrlCarpetaCiudadana()));
        ...
        rConfiguracionEntidad.setAyudaFormulario(
                generaFormularios(idEntidad.getFormularioIncidencias()));
