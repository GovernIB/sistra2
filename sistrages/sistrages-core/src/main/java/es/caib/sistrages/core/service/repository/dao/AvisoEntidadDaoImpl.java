...
public class AvisoEntidadDaoImpl implements AvisoEntidadDao {
     ...
     *
     * @see
     * es.caib.sistrages.core.service.repository.dao.AvisoEntidadDao#getById(
     * java. lang.Long)
     */
    @Override
    public AvisoEntidad getById(final Long pId) {
        ...
        final JAvisoEntidad jAvisoEntidad = entityManager
                .find(JAvisoEntidad.class, pId);
     ...
     *
     * @see
     * es.caib.sistrages.core.service.repository.dao.AvisoEntidadDao#add(long,
    ...
    public void add(final Long pIdEntidad, final AvisoEntidad pAvisoEntidad) {
        ...
        final JEntidad jEntidad = entityManager.find(JEntidad.class,
                pIdEntidad);
        if (jEntidad == null) {
            throw new FaltanDatosException(NO_EXISTE_LA_ENTIDAD + pIdEntidad);
        }

        final JAvisoEntidad jAvisoEntidad = JAvisoEntidad
                .fromModel(pAvisoEntidad);
     ...
     *
     * @see
     * es.caib.sistrages.core.service.repository.dao.AvisoEntidadDao#remove(
     * java. lang.Long)
     */
    @Override
     ...
     *
     * @see
     * es.caib.sistrages.core.service.repository.dao.AvisoEntidadDao#update(es.
    ...
    public void update(final AvisoEntidad pAvisoEntidad) {
        ...
        final JAvisoEntidad jAvisoEntidad = entityManager
                .find(JAvisoEntidad.class, pAvisoEntidad.getId());
        if (jAvisoEntidad == null) {
            throw new NoExisteDato(NO_EXISTE_EL_AVISO + pAvisoEntidad.getId());
        }
        // Mergeamos datos
        final JAvisoEntidad jAvisoEntidadNew = JAvisoEntidad
                .fromModel(pAvisoEntidad);
        jAvisoEntidadNew.setEntidad(jAvisoEntidad.getEntidad());
        jAvisoEntidadNew.setCodigo(pAvisoEntidad.getId());
        jAvisoEntidadNew.setMensaje(JLiteral.mergeModel(
                jAvisoEntidad.getMensaje(), pAvisoEntidad.getMensaje()));
     ...
     */
    @Override
    public List<AvisoEntidad> getAllByFiltro(final Long pIdEntidad,
            final TypeIdioma pIdioma, final String pFiltro) {
        if (pIdEntidad == null) {
            throw new FaltanDatosException(FALTA_ENTIDAD);
        }
     ...
     *
     * @see
     * es.caib.sistrages.core.service.repository.dao.AvisoEntidadDao#getAll(
     * java. lang.Long)
     */
    @Override
    ...
    private List<AvisoEntidad> listarAvisos(final Long pIdEntidad,
            final TypeIdioma pIdioma, final String pFiltro) {
    ...
    @Override
    public AvisoEntidad getAvisoEntidadByTramite(
            final String identificadorTramite) {
