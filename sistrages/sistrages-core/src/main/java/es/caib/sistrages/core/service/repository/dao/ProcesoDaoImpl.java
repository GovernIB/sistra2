...
import es.caib.sistrages.core.api.exception.ProcesoConfiguracionException;
import es.caib.sistrages.core.service.repository.model.JProceso;
...
public class ProcesoDaoImpl implements ProcesoDao {
	...
	public boolean verificarMaestro(final String instanciaId) {
		...
		final JProceso jProceso = entityManager.find(JProceso.class, ID_MAESTRO);
		if (jProceso == null) {
			throw new ProcesoConfiguracionException("No existe fila en tabla de procesos con id " + ID_MAESTRO);
		}
