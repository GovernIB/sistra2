...
public class RestApiInternaServiceBean implements RestApiInternaService {
    ...
    @Override
    @RolesAllowed(ConstantesRolesAcceso.REST)
    public List<ConfiguracionGlobal> listConfiguracionGlobal(
            final String filtro) {
    ...
    @Override
    @RolesAllowed(ConstantesRolesAcceso.REST)
    public List<Plugin> listPlugin(final TypeAmbito ambito,
            final Long idEntidad, final String filtro) {
        return restApiService.listPlugin(ambito, idEntidad, filtro);
    }

    @Override
    @RolesAllowed(ConstantesRolesAcceso.REST)
    public List<FormularioSoporte> listOpcionesFormularioSoporte(
    ...
    @Override
    @RolesAllowed(ConstantesRolesAcceso.REST)
    public TramiteVersion loadTramiteVersion(final String idTramite,
            final int version) {
    ...
    @Override
    @RolesAllowed(ConstantesRolesAcceso.REST)
    public Area loadArea(Long idArea) {
    ...
    @Override
    @RolesAllowed(ConstantesRolesAcceso.REST)
    public List<PlantillaIdiomaFormulario> getListaPlantillaIdiomaFormularioById(
            final Long idPlantillaFormulario) {
    ...
    @Override
    @RolesAllowed(ConstantesRolesAcceso.REST)
    public String getPaginaFormularioHTMLAsistente(final Long pIdPage,
            final String pLang) {
    ...
    public ValoresDominio realizarConsultaFuenteDatos(final String idDominio,
        ...
        return restApiService.realizarConsultaFuenteDatos(idDominio,
                parametros);
    }
