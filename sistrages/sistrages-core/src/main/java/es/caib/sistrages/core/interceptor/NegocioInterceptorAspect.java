package es.caib.sistrages.core.interceptor;
...
import es.caib.sistrages.core.api.exception.DatabaseException;
import es.caib.sistrages.core.api.exception.ErrorNoControladoException;
import es.caib.sistrages.core.api.exception.ServiceException;
import es.caib.sistrages.core.api.exception.ServiceRollbackException;
import es.caib.sistrages.core.api.model.comun.ConstantesNumero;
...
public final class NegocioInterceptorAspect {
   ...
   *          JointPoint
   */
  @Before("@annotation(es.caib.sistrages.core.interceptor.NegocioInterceptor)")
   ...
   *          Objeto retornado
   */
  @AfterReturning(pointcut = "@annotation(es.caib.sistrages.core.interceptor.NegocioInterceptor)", returning = "retVal")
   ...
   *          Exception
   */
  @AfterThrowing(pointcut = "@annotation(es.caib.sistrages.core.interceptor.NegocioInterceptor)", throwing = "ex")
