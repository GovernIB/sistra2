...
public class TramiteVersion extends ModelApi {
    ...
    public void setScriptInicializacionTramite(
            final Script scriptInicializacionTramite) {
     ...
     */
    public void setPlazoInicioDesactivacion(
            final Date plazoInicioDesactivacion) {
        if (plazoInicioDesactivacion == null) {
            this.plazoInicioDesactivacion = null;
        } else {
            this.plazoInicioDesactivacion = (Date) plazoInicioDesactivacion
                    .clone();
        }
    }
