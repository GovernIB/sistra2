...
public interface FormularioInternoService {
     ...
     */
    ObjetoFormulario addComponenteFormulario(TypeObjetoFormulario pTipoObjeto,
            Long pIdPagina, Long pIdLinea, Integer pOrden, String pPosicion);
     ...
     * @return objeto formulario
     */
    ObjetoFormulario updateComponenteFormulario(
            ComponenteFormulario pComponente);
     ...
     */
    PlantillaIdiomaFormulario uploadPlantillaIdiomaFormulario(Long idEntidad,
            final Long idPlantilla, PlantillaIdiomaFormulario plantilla,
            byte[] contents);
     ...
     */
    void removePlantillaIdiomaFormulario(
            PlantillaIdiomaFormulario plantillaIdiomaFormulario);
     ...
     */
    String getPaginaFormularioHTMLDisenyo(final Long pIdPagina,
            final String pLang);
